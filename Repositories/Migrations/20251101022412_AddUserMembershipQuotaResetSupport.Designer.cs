...
namespace Repositories.Migrations
{
    ...
    [Migration("20251101022412_AddUserMembershipQuotaResetSupport")]
    partial class AddUserMembershipQuotaResetSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObjects.ClubMember", b =>
                {
            ...
            modelBuilder.Entity("BusinessObjects.Community", b =>
                {
                    ...
                    b.HasIndex("CreatedAtUtc")
                        .HasDatabaseName("IX_Community_CreatedAt");

                    b.HasIndex("IsPublic")
                        .HasDatabaseName("IX_Community_IsPublic");

                    b.HasIndex("MembersCount");

                    b.HasIndex("School")
                        .HasDatabaseName("IX_Community_School");

                    b.HasIndex("IsPublic", "MembersCount")
                        .HasDatabaseName("IX_Community_Public_Members");
            ...
            modelBuilder.Entity("BusinessObjects.CommunityGame", b =>
                {
                    ...
                    b.HasIndex("CommunityId")
                        .HasDatabaseName("IX_CommunityGame_CommunityId");

                    b.HasIndex("GameId")
                        .HasDatabaseName("IX_CommunityGame_GameId");
            ...
            modelBuilder.Entity("BusinessObjects.MembershipPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("payment_intents", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_payment_intent_purpose_allowed", "\"Purpose\" IN ('TopUp','EventTicket','WalletTopUp','Membership')");
                    ...
                    b.ToTable("rooms", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_room_password_required", "(\"JoinPolicy\" <> 'RequiresPassword') OR (\"JoinPasswordHash\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("BusinessObjects.RoomMember", b =>
                {
                    ...
                    b.HasIndex("JoinedAt")
                        .HasDatabaseName("IX_RoomMember_JoinedAt");

                    b.HasIndex("Status");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_RoomMembers_UserId");

                    b.HasIndex("RoomId", "JoinedAt")
                        .HasDatabaseName("IX_RoomMember_Room_JoinedAt");

                    b.HasIndex("RoomId", "Status")
                        .HasDatabaseName("IX_RoomMember_RoomId_Status");
            ...
            modelBuilder.Entity("BusinessObjects.UserMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("RemainingEventQuota")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.ToTable("user_memberships", null, t =>
                        {
                            t.HasCheckConstraint("chk_user_membership_quota_nonneg", "\"RemainingEventQuota\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("BusinessObjects.PaymentIntent", b =>
                {
                    ...
                    b.HasOne("BusinessObjects.MembershipPlan", "MembershipPlan")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessObjects.UserMembership", b =>
                {
                    ...
                    b.HasOne("BusinessObjects.User", "User")
                        .WithOne("Membership")
                        .HasForeignKey("BusinessObjects.UserMembership", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
